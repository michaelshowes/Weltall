...
export function generateComponent(type, input) {
    ...
    function createComponent() {
        ...
        if (pageType) {
            writeFile(`${componentDirectory}/page.tsx`, page(name)).catch(writeFileErrorHandler);
            ...
            console.log(`${chalk.green(`${name}.tsx`)} was created in src/components/${name}/`);
        }
        ...
        if (type !== 'page') {
            ...
            console.log(`${chalk.green(`${toCamelCase(name)}.module.scss`)} was created in src/components/${name}/`);
        }
    }
    // handle errors
